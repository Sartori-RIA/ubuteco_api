  ...
  module Dashboard
    class RangeParser
      ...
      def parse
        ...
        raise InvalidRange, I18n.t('dashboard.errors.from_after_to') if from_date > to_date
        raise InvalidRange, I18n.t('dashboard.errors.range_exceeds_max', max: MAX_SPAN_DAYS) if (to_date - from_date).to_i > MAX_SPAN_DAYS
