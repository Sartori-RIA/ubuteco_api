...
RSpec.describe Api::MakersController, type: :request do
  ...
  describe '#GET /api/makers' do
    it 'should request all beer' do
      get api_makers_path, headers: auth_header(user)
  ...
  describe '#GET /api/makers/:id' do
    it 'should request maker by id' do
      get api_maker_path(makers.sample.id), headers: auth_header(user)
      expect(response).to have_http_status(200)
    end
  end
  ...
  describe '#POST /api/makers' do
    it 'should create a maker' do
      ...
      post api_makers_path, params: attributes.to_json, headers: auth_header(user)
      expect(response).to have_http_status(201)
    end
    it 'should throw error with invalid params' do
      post api_makers_path, headers: auth_header(user)
  ...
  describe '#DELETE /api/makers/:id' do
    it 'should delete maker' do
      delete api_maker_path(makers.sample.id), headers: auth_header(user)
