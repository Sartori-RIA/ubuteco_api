...
RSpec.describe Api::FoodsController, type: :request do
  ...
  describe '#GET /api/foods' do
    it 'should request all foods' do
      get api_foods_path, headers: auth_header(user)
  ...
  describe '#GET /api/foods/:id' do
    it 'should request food by id' do
      get api_food_path(foods.sample.id), headers: auth_header(user)
      expect(response).to have_http_status(200)
    end
  end
  ...
  describe '#GET /api/foods/search' do
    it 'should search foods' do
      get search_api_foods_path, params: {q: 'tralala'}, headers: auth_header(user)
      expect(response).to have_http_status(200)
    end
  end
  ...
  describe '#POST /api/foods' do
    it 'should create a food' do
      ...
      post api_foods_path, params: attributes.to_json, headers: auth_header(user)
      expect(response).to have_http_status(201)
    end
    it 'should throw error with invalid params' do
      post api_foods_path, headers: auth_header(user)
  ...
  describe '#DELETE /api/foods/:id' do
    it 'should delete food' do
      delete api_food_path(foods.sample.id), headers: auth_header(user)
