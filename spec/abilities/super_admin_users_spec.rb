...
RSpec.describe Abilities::SuperAdminAbility, type: :ability do
  ...
  describe 'users index permissions' do
    it 'allows managing any user on the global users controller' do
    ...
    it 'scopes users to the organization on nested users controller' do
      ability = described_class.new(
        user: super_admin,
